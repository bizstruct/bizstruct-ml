# `architecture`, `empathy_map`, `scenario`, `pitch`, and `hypotheses` are
# sourced from bizstruct_domain — the local schemas were deleted in favor
# of the shared domain model (see bizstruct-domain repo).
